...
const { MySQLClient, sql } = require("../lib/databases/client.js");
...
var validateReviewData = function(req){
    ...
    if(body.visit && !moment(body.visit, DATA_FORMAT).isValid()){
        isValid = false;
...
var createReviewData = function(req){
    ...
    return{
        ...
        visit: (date = moment(body.visit, DATA_FORMAT)) && date.isValid() ? date.toDate() : null,
        post: new Date(),
